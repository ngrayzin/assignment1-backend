...
func main() {
	...
	router.HandleFunc("/api/v1/trips", trips).Methods(http.MethodGet, http.MethodPut)
	router.HandleFunc("/api/v1/trips/{id}", trips).Methods(http.MethodGet, http.MethodPut)
